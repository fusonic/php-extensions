...
[![php 8.3+](https://img.shields.io/badge/php-min%208.3-blue.svg)](https://gitlab.com/fusonic/devops/php/extensions/-/blob/12-open-source-preparations/packages/ddd-extensions/composer.json)
