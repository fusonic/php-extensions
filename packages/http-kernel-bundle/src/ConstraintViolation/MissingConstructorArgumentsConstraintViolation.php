...
{
    private const int EXPECTED_MATCHES = 3;
    ...
    public function __construct(MissingConstructorArgumentsException $exception)
    {
        ...
        $matches = [];
        $pattern = '/Cannot create an instance of "(.+)" from serialized data because its constructor requires the following parameters to be present : "(.+)"\./';
